...
!(function (e, t) {
	...
	function o(e) {
		function t(e) {
			...
			var t = e.done;
			return Promise.resolve(e.value).then(
				function (e) {
	...
	function ee(e, t) {
		...
		t = t.toLowerCase();
		for (
			var r, n = Object.keys(e), o = n.length;
			o-- > 0;
		...
		Ue =
			...
			(!Ce ||
				[
					...
					'NativeScript',
					'NS',
				].indexOf(Ce.product) < 0),
		Fe =
			'undefined' != typeof WorkerGlobalScope &&
			self instanceof WorkerGlobalScope &&
			'function' == typeof self.importScripts,
		Be =
			(_e && window.location.href) ||
			'http://localhost',
		De = u(
			u(
				{},
	...
	var Bt = {
			assertOptions: function (e, t, r) {
				...
				for (
					var n = Object.keys(e), o = n.length;
					o-- > 0;
	...
	return (
		...
		(Wt.formToJSON = function (e) {
			return qe(
				ye.isHTMLForm(e) ? new FormData(e) : e,
			);
		}),
		(Wt.getAdapter = Lt),
